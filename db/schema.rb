...
ActiveRecord::Schema.define(version: 2019_07_31_014549) do
  ...
  create_table "god_locations", force: :cascade do |t|
    t.integer "god_id"
  ...
  create_table "gods", force: :cascade do |t|
    ...
    t.text "animals", default: [], array: true
    t.string "mother"
    t.string "father"
    t.text "siblings", default: [], array: true
